...
/*
void NRF24_printReg(uint8_t reg)
{
    uint8_t reg8Val;
    char uartTxBuf[100];
    ...
    reg8Val = NRF24_read_register(reg);
    sprintf(uartTxBuf,
            "Reg:\r\n    BIT_7:    %d\r\n    BIT_6:    %d\r\n    BIT_5:    %d\r\n    BIT_4:    %d\r\n    BIT_3:    %d\r\n    BIT_2:    %d\r\n    BIT_1:    %d\r\n    BIT_0:    %d\r\n",
            _BOOL(reg8Val & (1 << 7)), _BOOL(reg8Val & (1 << 6)),
            _BOOL(reg8Val & (1 << 5)), _BOOL(reg8Val & (1 << 4)),
            _BOOL(reg8Val & (1 << 3)), _BOOL(reg8Val & (1 << 2)),
